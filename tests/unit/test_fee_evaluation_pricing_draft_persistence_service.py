...
def test_save_then_load_current_pricing_draft_preserves_notes() -> None:
    ...
    assert loaded.saved_snapshot.fee_rule_version_id == "fee_rules_v2026_08_23_r10"
...
def test_load_blocks_when_only_unknown_fee_rule_version_draft_exists() -> None:
    ...
    assert result.status == "blocked"
    assert result.current_context.fee_rule_version_id == "fee_rules_v2026_08_23_r10"
    assert result.saved_snapshot is None
    ...
    with pytest.raises(
        ...
        service.save(
            SaveFeeEvaluationPricingDraftCommand(
                ...
                expected_fee_rule_version_id="fee_rules_v2026_08_23_r10",
            )
        )
...
def test_discard_uses_current_context_when_newer_stale_row_exists() -> None:
    ...
    assert result.discarded is True
    assert store.deleted_context == ("P1", "cmv-1", 1, "fee_rules_v2026_08_23_r10")
...
def _pricing_snapshot(
    *,
    ...
    fee_rule_version_id: str = "fee_rules_v2026_08_23_r10",
