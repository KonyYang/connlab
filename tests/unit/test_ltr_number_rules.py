...
def test_parse_standard_dl_number_with_suffix() -> None:
    """Standard DL values can carry an existing suffix."""
    parsed = parse_ltr_number("DL-2026-04-001A")
    ...
    assert base_ltr_number("DL-2026-04-001A") == "DL-2026-04-001"
    assert family_stem("DL-2026-04-001A") == "DL-2026-04-001"
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("DL-2026-04-001ABC", "LTR number must match"),
