...
const apiMocks = vi.hoisted(() => ({
  ...
  previewMatrixMethodVersionSync: vi.fn(),
  applyMatrixMethodVersionSync: vi.fn(),
  suggestMatrixMethodVersions: vi.fn(),
  ...
  exportMatrixEditorLiveXlsx: vi.fn(),
...
vi.mock("../../api/client", () => {
  ...
  return {
    ...
    previewMatrixMethodVersionSync: apiMocks.previewMatrixMethodVersionSync,
    applyMatrixMethodVersionSync: apiMocks.applyMatrixMethodVersionSync,
    suggestMatrixMethodVersions: apiMocks.suggestMatrixMethodVersions,
    ...
    exportMatrixEditorLiveXlsx: apiMocks.exportMatrixEditorLiveXlsx,
