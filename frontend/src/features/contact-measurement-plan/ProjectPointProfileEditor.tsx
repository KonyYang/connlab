...
export function ProjectPointProfileEditor({ model, onCancel, onConfirmed }: ProjectPointProfileEditorProps) {
  return <section className="project-point-profile-editor" aria-label="Project point profile">
    <header className="project-point-profile-header"><div><h2>Project point profile</h2><p>{`${model.total} points / sample`}</p></div></header>
