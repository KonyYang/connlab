...
Improve deterministic `.docx` parser coverage for the real application form layout documented in `docs/archive/historical_plans/phase7_real_sample_baseline.md`.
