...
class LlcrCrSpecializedRecordArtifactStore:
    ...
    def prepare(self, *, project_id: str, confirmed_revision: int, record_type: str = "llcr") -> LlcrCrSpecializedRecordArtifact:
        ...
        file_name = f"{display_project}_{record_type}_record_r{confirmed_revision}_{artifact_id}.xlsx"
