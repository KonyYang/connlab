...
Archive documents may still be useful for:
...
Moving a document into this archive is a classification change, not a claim that its content is wrong. It means the document is no longer part of the active read path.
