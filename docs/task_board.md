...
```json
{
  ...
  "active": {
    ...
    "updated_at": "2026-09-20T01:31:14.480947Z",
    "checkpoint": {
      ...
      "stage": "revision",
      "status": "running",
      "summary": "User feedback: Matrix project information still scrolls out of view; make the complete Matrix action card persist at the top.",
      "requires_user": false
    },
    "report": null
  },
