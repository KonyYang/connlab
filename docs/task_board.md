...
```json
{
  ...
  "active": {
    ...
    "blocker": {
      ...
      "version": 1,
      "code": "SCOPE_EXPANDED",
      "reason": "Required acceptance command scripts/connlab_active_context.py inspect rejects the new personal board schema, but that helper is explicitly outside the approved allowlist.",
      "dirty_paths": [
        ".agents/skills/connlab-lane-orchestrator/SKILL.md",
        ".agents/skills/connlab-planner/SKILL.md",
        "AGENTS.md",
      ...
      "recorded_at": "2026-08-05T22:46:37.207387+00:00"
    },
    "validation": null
  },
  "queue": [],
