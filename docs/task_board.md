...
```json
{
  ...
  "active": {
    ...
    "approval_ref": "请继续并快速收口同一任务：\r\n\r\nTASK_ID:\r\nTASK_GOVERNANCE_ORCHESTRATOR_LATENCY_AND_MODEL_ROUTING\r\n\r\n当前 adoption plan 已 zero-write fail-closed。根因是现有 helper 的静态 evidence prefix\r\n截止于 da835ad0，却漏掉正常 production-writer 路线产生的 Developer attempt 9 和\r\nReviewer attempt 8 evidence。\r\n\r\n这是现有五路径、同一 Plan 和同一任务内的明确修复，不是新 scope、产品行为、\r\nboard schema 或治理框架变更。禁止启动 Planner loop或创建新 helper。\r\n\r\n一、冻结当前 S_QA 安全基线\r\n\r\n开始前重新核验：\r\n\r\n- primary clean at:\r\n  9976cc5f86c74fb6a85103cb45b165ca63d4f244\r\n- raw board SHA-256:\r\n  99783646cb3fb75d294af53e2bb1fd06e90cc40907daecfb8781a6bb10d21376\r\n- board:\r\n  running/integration\r\n- blocker/current_role/pending_callback:\r\n  null\r\n- Plan ref:\r\n  docs/task_governance_orchestrator_latency_and_model_routing_plan.md@b3429fd1ba27922d2f9149e711f8ca6a27e81d1e#fc0deda4c06f3c90c0c944e49141d79dad87e7377e974b15b4fe5bf1571c42da\r\n- candidate clean at:\r\n  61aa72f4e7a38ed6368a61bdc9bbc7bff92b05ba\r\n- original lane clean at:\r\n  f7770b6a6a82a36f946d16145a2124f6330961e1\r\n- adoption writer 未调用；\r\n- 无 rebind、Final CAS、merge、push 或 cleanup。\r\n\r\n精确合法 evidence route 必须包含：\r\n\r\n1. Developer attempt 9:\r\n   docs/lane_evidence/TASK_GOVERNANCE_ORCHESTRATOR_LATENCY_AND_MODEL_ROUTING_integration-reconciliation_developer.md@6571d059f19b003033cf3c482a675604d4421507#500232570f0d65ac343358bd972fca128f105e097960f41be3827e426d8be45f\r\n2. Reviewer attempt 8 blocker:\r\n   docs/lane_evidence/TASK_GOVERNANCE_ORCHESTRATOR_LATENCY_AND_MODEL_ROUTING_integration-reconciliation_reviewer.md@c2f96af22e3f505bc6b99cfaa8f61291f12c60aa#3c536576d894eef4ba28866536560d669a05b12ce5f22f5398e2610ca0c8be06\r\n3. Final Developer:\r\n   docs/lane_evidence/TASK_GOVERNANCE_ORCHESTRATOR_LATENCY_AND_MODEL_ROUTING_integration-reconciliation_developer.md@b93731c82e73097195966699d6af7d876a6fff80#5499c573813be840ada74d04f922cbf32cdbc55e126454282c13b9b397498b55\r\n4. Final Reviewer pass:\r\n   docs/lane_evidence/TASK_GOVERNANCE_ORCHESTRATOR_LATENCY_AND_MODEL_ROUTING_integration-reconciliation_reviewer.md@a97c312c24ed6f3b736a8c38d21b064d50c7bf92#9b86c51e67ce909951c3c765bd6f27cc4a8e9c9a73a61e2907a796f67c8d0f02\r\n5. Final QA pass:\r\n   docs/lane_evidence/TASK_GOVERNANCE_ORCHESTRATOR_LATENCY_AND_MODEL_ROUTING_integration-reconciliation_qa.md@61aa72f4e7a38ed6368a61bdc9bbc7bff92b05ba#86327e989f3f8013b54bdf190f4388051aadd1987b7fde0a482996bd75cd0cdb\r\n\r\n任一事实不符立即停止。\r\n\r\n二、使用现有 writer 合法返回 development\r\n\r\n我明确授权以下一次性 same-task authority route：\r\n\r\n1. 记录 canonical APPROVAL_REQUIRED blocker：\r\n\r\n- schema=connlab.serial-task-blocker\r\n- version=1\r\n- code=APPROVAL_REQUIRED\r\n- stage=integration\r\n- reason=Authorize the exact bounded post-QA evidence-prefix recovery before implementation.\r\n- dirty_paths=[]\r\n- failed_validation=null\r\n- subject_commit=null\r\n- evidence_ref=null\r\n- native_action_id=null\r\n- related_ids=[\"POST_QA_EVIDENCE_PREFIX_RECOVERY\"]\r\n- retryable=true\r\n- requires_user=true\r\n- resume_phase=awaiting_user_approval\r\n- recorded_at=<一次 attested UTC>\r\n\r\n2. exact-stage/commit 唯一 docs/task_board.md transition；\r\n3. 使用本消息作为 decision ref，resume 到 awaiting_user_approval；\r\n4. exact-stage/commit 唯一 board transition；\r\n5. 使用 section 12.7 byte-identical 十路径 approved-request、现有 Plan ref 和本消息作为\r\n   ApprovalRef 执行 same-scope Approve；\r\n6. exact-stage/commit 唯一 board transition，形成新的 recovery S_AUTH；\r\n7. 只有 committed recovery S_AUTH 完成后才允许 Developer 开始。\r\n\r\n每次 writer 调用前从 board 原始字节重新计算 expected SHA。任何其他结果立即停止。\r\n\r\n三、Developer bounded recovery\r\n\r\n派发同一 task host 的下一个合法 Developer attempt：\r\n\r\nMODEL: gpt-5.6-sol\r\nREASONING_EFFORT: medium\r\nMODEL_ROUTE_REASON: risk:integration_conflict\r\n\r\nImplementation May Touch 仅限现有五路径：\r\n\r\n1. scripts/connlab_model_routing_integration_reconciliation.py\r\n2. scripts/connlab_model_routing_ancestry_contract.py\r\n3. tests/unit/test_task_governance_orchestrator_latency_model_routing_reconciliation.py\r\n4. tests/integration/test_task_governance_orchestrator_latency_model_routing_reconciliation.py\r\n5. tests/integration/test_task_governance_orchestrator_latency_model_routing_ancestry_adoption.py\r\n\r\n固定 Developer evidence 路径仍为 role evidence，不属于 implementation scope。\r\n\r\n修复要求：\r\n\r\n1. 不得仅宽泛接受任意新增 evidence。\r\n2. 从 committed S_AUTH board 读取真实 evidence prefix。\r\n3. 逐提交重放 S_AUTH..S_QA production-writer transitions，并收集每个合法 callback\r\n   精确追加的 evidence ref。\r\n4. adoption 期望 evidence 必须等于：\r\n   S_AUTH committed prefix\r\n   + 重建路线中精确追加的 evidence refs；\r\n   不得依赖截止于 da835ad0 的过期静态截断。\r\n5. 精确验证 attempt 9 Developer、attempt 8 Reviewer blocker、最终 D/R/Q 的\r\n   task/role/status/subject/model、commit/blob/hash、顺序和 direct ancestry。\r\n6. 当前 QA checkpoint\r\n   61aa72f4e7a38ed6368a61bdc9bbc7bff92b05ba\r\n   作为一次性 recovery base。\r\n7. 只允许该精确 QA checkpoint 的直接后代进入本次 repair B→D→R→Q 尾链；\r\n   不得建立通用 `qa_pass → implementation` 放宽。\r\n8. 新 recovery S_AUTH..新 S_QA 的每个 primary commit 必须是生产 writer 生成的\r\n   单父、board-only durability commit。\r\n9. arbitrary evidence、缺失、重复、重排、伪造 hash、未知 commit、普通 QA-pass 后实现、\r\n   dirty/divergent/later descendant 全部稳定零写入阻断。\r\n10. adoption plan/apply/replay、rebind、Final CAS、retained-resource 与 closeout 合同保持不变。\r\n\r\nTDD 必须先复现当前真实 S_QA 返回\r\nBLOCKED_RECONCILIATION_EVIDENCE，再完成 GREEN。\r\n\r\n四、验证和最终路线\r\n\r\nDeveloper 必须运行：\r\n\r\n- 48 unit；\r\n- 当前完整 integration matrix，并增加此次真实 prefix/recovery 正负例；\r\n- 43 compatibility；\r\n- 13 workflow；\r\n- py_compile；\r\n- git diff --check；\r\n- 所有 Python 文件 ≤500 行；\r\n- candidate/original lane/primary zero-drift checks。\r\n\r\n创建 clean implementation subject 和 Developer evidence commit后：\r\n\r\nDeveloper ready\r\n→ 完整 Reviewer re-gate\r\n→ mandatory QA\r\n→ 新 S_QA\r\n→ adoption zero-write plan\r\n→ byte-identical apply\r\n→ 唯一 board durability commit\r\n→ Integrator rebind\r\n→ Final CAS\r\n→ local Integrator acceptance\r\n→ implemented_pending_human_review\r\n→ 停止等待用户“关闭”。\r\n\r\nReviewer 与 QA pass 前禁止 adoption。Adoption durability commit 前禁止 rebind。\r\n\r\n五、禁止事项\r\n\r\n- 不扩大十路径 scope；\r\n- 不创建新 helper、测试模块、Task、Plan、schema或治理框架；\r\n- 不启动 Planner loop；\r\n- 不修改产品/backend/frontend、原 lane或既有 merge；\r\n- 不手工编辑 board；\r\n- 不 reset、restore、stash、rebase、cherry-pick、重新 merge、push、cleanup；\r\n- 不通过硬编码忽略合法 evidence，也不接受任意 evidence descendant；\r\n- 任意新的 scope/authority/schema 或无法解释的测试失败立即零写入停止。\r\n\r\n成功后仅返回 local Integrator acceptance、adoption/rebind/Final CAS SHA、\r\nevidence refs、ACTUAL_MODEL_ROUTING、retained disposition 和 no-push/no-cleanup 声明。",
    "activation_parent_sha": "38372b9351a5ab84007bcde4728a07fefa2dae43",
    "activated_at": "2026-08-08T00:31:25Z",
    "updated_at": "2026-08-11T04:36:21Z",
    "blocker": {
      "schema": "connlab.serial-task-blocker",
      "version": 1,
      "code": "QA_BLOCKED",
      "stage": "integration",
      "reason": "Post-QA adoption preflight found the reviewed helper frozen to the wrong immutable S_AUTH approval hash.",
      "dirty_paths": [],
      "failed_validation": {
        "schema": "connlab.serial-failure-proof",
        "version": 1,
        "operation": "post-qa-adoption-preflight",
        "command": [
          "py",
          "candidate:scripts/connlab_model_routing_integration_reconciliation.py",
          "verify_adoption_repository_contract"
        ],
        "exit_code": 1,
        "summary": "BLOCKED_RECONCILIATION_CONTEXT: User approval identity drifted; reviewed=e1abcbbc1203b780e16d4b2283363e22a60522d9ef3f5459df1e0a53a441dd8c; committed=8ca96de2b15bdbb28cf2716295e4c256b88279050a896ce20842af519de2a30c.",
        "recorded_at": "2026-08-11T06:00:00Z"
      },
      "subject_commit": "8f6379d3bde0af81a1ff8e95c69238d0919826fe",
      "evidence_ref": "docs/lane_evidence/TASK_GOVERNANCE_ORCHESTRATOR_LATENCY_AND_MODEL_ROUTING_integration-reconciliation_qa.md@38e453e082711d3b26a4d3d5592ed15055685493#d13abb74b029d87b26897e9bb11249b6c2cc7197cbbccdd28d757d75a042d9e7",
      "native_action_id": null,
      "related_ids": [
        "POST_QA_ADOPTION_APPROVAL_IDENTITY"
      ],
      "retryable": true,
      "requires_user": false,
    ...
    "complex_context": {
      ...
      "developer_subject_commit": "8f6379d3bde0af81a1ff8e95c69238d0919826fe",
      "reviewer_subject_commit": "8f6379d3bde0af81a1ff8e95c69238d0919826fe",
      "qa_subject_commit": "8f6379d3bde0af81a1ff8e95c69238d0919826fe",
