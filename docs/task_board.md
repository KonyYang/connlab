...
```json
{
  ...
  "active": {
    ...
    "updated_at": "2026-08-12T11:43:42Z",
    "blocker": {
      "schema": "connlab.serial-task-blocker",
      "version": 1,
      "code": "APPROVAL_REQUIRED",
      "stage": "development",
      "reason": "Bind the approved final reconciliation verifier architecture v2 before implementation.",
      "dirty_paths": [],
      "failed_validation": null,
      "subject_commit": null,
      "evidence_ref": null,
      "native_action_id": null,
      "related_ids": [
        "FINAL_RECONCILIATION_VERIFIER_ARCHITECTURE"
      ],
      "retryable": true,
      "requires_user": true,
      "resume_phase": "awaiting_user_approval",
      "recorded_at": "2026-08-12T11:43:42Z"
    },
    "validation": null,
    "complex_context": {
      "workflow_version": 1,
