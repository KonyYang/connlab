...
- Next recommended controlled task: frontend wiring task for Matrix revision actions (create revision draft / confirm revision) in Matrix Editor, pending explicit scope approval.
