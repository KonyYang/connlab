...
```json
{
  ...
  "active": {
    ...
    "scope_contract": {
      ...
      "targeted_validation": [
        "temporary Git repository Create/reuse/conflict smoke",
        "py -m pytest tests/unit/test_connlab_serial_complex_worktree.py -q",
        "git diff --check"
      ],
  ...
  "last_closed": {
    ...
    "closeout_evidence_ref": "docs/lane_evidence/TASK_MATRIX_IMPORT_DEFAULT_SOURCE_DIRECTORY_closeout.md@08e82405b5949d3d49ae46019c31c32be6eae47b#18880de9364a9ec0b32787b75749d986cb9638826f1e1dd6d8c22d3b13317bc9",
    "retained_resources": {
    ...
    "closed_at": "2026-08-13T23:14:22Z"
  },
  "retained_history": [
    {
