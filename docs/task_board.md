...
```json
{
  ...
  "active": {
    ...
    "updated_at": "2026-09-15T13:20:48.279103Z",
    "checkpoint": {
      ...
      "stage": "revision",
      "status": "running",
      "summary": "User reported Fee Form incorrectly blocks with 'The recorded official project folder is missing.'; preserve browser download fallback when no usable official folder exists.",
      "requires_user": false
    },
    "report": null
  },
