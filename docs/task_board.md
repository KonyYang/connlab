...
```json
{
  ...
  "active": {
    ...
    "summary": "Complete the ordinary-browser Matrix Import source picker from a fresh Personal Serial V2 task while retaining prior implementation as audit material: list only direct .doc/.docx/.pdf files from the resolved project source directory, show only source title and filename, preserve Cancel and Upload other file, bind opaque IDs to directory and current file identity, reject stale selections, and preserve desktop/read-only behavior.",
    "kind": "planned",
    ...
    "plan_ref": null,
    "approval_ref": null,
    "activation_parent_sha": "13f7aafdb3cf811463af521d3cb86c0020c07dad",
    "activated_at": "2026-08-17T11:25:29Z",
    "updated_at": "2026-08-17T11:25:29Z",
    "blocker": null,
    "validation": null,
    "complex_context": {
      "workflow_version": 1,
      "task_branch": null,
      "task_worktree": null,
      "base_sha": "13f7aafdb3cf811463af521d3cb86c0020c07dad",
      "head_sha": "13f7aafdb3cf811463af521d3cb86c0020c07dad",
  ...
  "last_closed": {
    ...
    "disposition": "product subject 9f5fda4dbae711eb4e0800b35b8bb90cfc5a96d2, branch, worktree, Task, Plan, evidence, governance repair and all commits retained; current unprovable Reviewer callback topology terminated solely to restart the same product goal through a fresh workflow; no cleanup authorized",
    "decision_ref": "User requested closing the repeatedly blocked task and restarting the same product goal through a completely fresh Personal Serial V2 process.",
    "closed_at": "2026-08-17T11:24:38Z"
  },
  "retained_history": [
    {
