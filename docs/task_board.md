...
```json
{
  ...
  "active": {
    ...
    "updated_at": "2026-08-12T00:06:30Z",
    "blocker": {
      "schema": "connlab.serial-task-blocker",
      "version": 1,
      "code": "QA_BLOCKED",
      "stage": "integration",
      "reason": "Exact post-QA recovery edge is required before adoption.",
      "dirty_paths": [],
      "failed_validation": {
        "schema": "connlab.serial-failure-proof",
        "version": 1,
        "operation": "post_qa_adoption_plan",
        "command": [],
        "exit_code": null,
        "summary": "BLOCKED_RECONCILIATION_EVIDENCE: implementation does not follow an approved fix-loop edge",
        "recorded_at": "2026-08-12T00:06:29.9074340Z"
      },
      "subject_commit": "a069215b9f9929c6506f1045f39e821235678924",
      "evidence_ref": "docs/lane_evidence/TASK_GOVERNANCE_ORCHESTRATOR_LATENCY_AND_MODEL_ROUTING_integration-reconciliation_qa.md@f67a9928b4db78f19e8ff0d39f9c0a53567f50f2#fc82d2fc003c8bf35a45ef33f0a897f30aa5d8fef7e171006affc2c678af4943",
      "native_action_id": null,
      "related_ids": [
        "POST_QA_EXACT_RECOVERY_EDGE"
      ],
      "retryable": true,
      "requires_user": false,
