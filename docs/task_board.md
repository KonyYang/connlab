...
- Next recommended action: define and approve next controlled task for Source Matrix import execution path (`.docx` import entry + persistence consumption boundary) before confirmed-authority implementation.
