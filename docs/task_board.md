...
```json
{
  ...
  "active": {
    ...
    "updated_at": "2026-09-22T14:49:44.240195Z",
    "checkpoint": {
      ...
      "stage": "revision",
      "status": "running",
      "summary": "User reports the current legacy project still cannot reconcile its existing folder and the template path source appears stale.",
      "requires_user": false
    },
    "report": null
  },
